...
export default defineConfig(function (_a) {
    ...
    var mode = _a.mode;
    // 根据环境变量加载环境变量文件
    var ASR_ENV = dotenv.parse(fs.readFileSync(".env.".concat(mode)));
    return {
        ...
        server: {
            ...
            port: 2400,
            proxy: (_b = {},
                _b[ASR_ENV.VITE_BASE_API] = {
                    target: "".concat(ASR_ENV.VITE_BASE_PATH),
                    changeOrigin: true,
            ...
            rollupOptions: {
                output: {
                    ...
                    assetFileNames: function (assetInfo) {
                        ...
                        if (/\.(png|jpe?g|gif|svg|webp|ico)$/.test((_b = assetInfo.name) !== null && _b !== void 0 ? _b : "")) {
